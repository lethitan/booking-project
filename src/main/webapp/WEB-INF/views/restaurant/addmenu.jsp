							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<s:form action="${pageContext.request.contextPath }/restaurant/addmenu" enctype="multipart/form-data" commandName="menu" modelAttribute="menu" class="form-horizontal form-bordered" method="post">

...
<mt:template_restaurant title="Create restaurant">
							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<s:form action="${pageContext.request.contextPath }/restaurant/addRes"  modelAttribute="restaurant" class="form-horizontal form-bordered" method="post">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<s:input path="photo" type="file" name="file" class="form-control"/>
												</div>
											</div>			
											<div class="form-group">

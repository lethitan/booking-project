  ...
  <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        <li><a href="${pageContext.request.contextPath }/user/menu/${sessionScope.id}">All</a></li>
                    </ul>
                </div>
              <c:forEach var="cate" items="${categorys}">
              <div class="catagories-menu">
                    <ul>
                        <li><a href="${pageContext.request.contextPath }/user/findByCate/${cate.id}">${cate.name}</a></li>
                    </ul>
                </div>
                </c:forEach>
                <div class="catagories-menu">
                    <ul>
                        <li><a href="${pageContext.request.contextPath }/user/table/${sessionScope.id}">Table</a></li>
                    </ul>
                </div>
            </div>
 ...
 <div class="amado_product_area section-padding-100">
            ...
            <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                <div class="single-product-wrapper">
                            ...
                            <!-- Product Image -->
                            <a
									href="${pageContext.request.contextPath }/user/detail/${menu.id}">
                     <div class="product-img">
                          <img
                                ...
                                <!-- Hover Thumb -->
                          <img class="hover-img"
											src="${pagecontext.request.contextpath }/assets/images/${menu.photos[1].name}"
											alt="">
                     </div>
</a>
                            <!-- Product Description -->
                     <div
                         ...
                         <div class="product-meta-data">
                              ...
                              <a href="${pageContext.request.contextPath }/user/detail/${menu.id}">
                                       <h6>${menu.name }</h6> 
                              </a>
                         </div>
                                <!-- Ratings & Cart -->
                             ...
                             <div class="ratings">
                              ...
                              <div class="cart">
                                        <a
												...
												title="My favorite">
												<img
												src="${pageContext.request.contextPath }/resources/user/img/core-img/favorite.png"
												alt="" width="20" height="20">
											</a>
											<a
												href="${pageContext.request.contextPath }/user/buy/${menu.id}"
												data-toggle="tooltip" data-placement="left"

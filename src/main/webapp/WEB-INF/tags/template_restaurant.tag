...
$(document).ready(function () { 
	/* $.ajax({
        ...
        url: '${pageContext.request.contextPath}/api/order/findall',
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/restaurant/assets/css/cs-skin-elastic.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/restaurant/assets/css/style.css">
...
<body>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="${pageContext.request.contextPath }/restaurant/restaurantdetail/${sessionScope.res_id}"><i
					...
					<s:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li>
						<a href="${pageContext.request.contextPath }/restaurant/addcategory/${sessionScope.res_id}">Category</a>
						</li>
						<li>
						<a href="${pageContext.request.contextPath }/restaurant/addtable/${sessionScope.res_id}">Table</a>
						</li>
						<li>
							<a href="${pageContext.request.contextPath }/restaurant/menuAdmin/${sessionScope.res_id}">Menu for Admin</a>
						</li>
						<li>
							<a href="${pageContext.request.contextPath }/restaurant/editRes/${sessionScope.res_id}">Update restaurant</a>
						</li>
						<li ><a href="${pageContext.request.contextPath }/restaurant/deleteRes/${sessionScope.res_id}"> Delete the restaurant</a>
					</s:authorize>
					<s:authorize access="hasRole('ROLE_RESTAURANT')">
					
						<li>
							<a href="${pageContext.request.contextPath }/restaurant/menu/${sessionScope.res_id}">Menu</a>
						</li>
						<li><i class="fa fa-table"></i><a href="${pageContext.request.contextPath }/restaurant/neworder/${sessionScope.res_id}">New order</a></li>
					</s:authorize>
					...
					<li class="menu-title">Disable the restaurant</li>
					<!-- /.menu-title -->
			...
			<div class="top-left">
				<div class="navbar-header">
					<a class="navbar-brand" href="./"><img
						src="${pageContext.request.contextPath}/resources/restaurant/images/logo.png"
						alt="Logo"></a> <a class="navbar-brand hidden" href="./"><img
						src="${pageContext.request.contextPath}/resources/restaurant/images/logo2.png"
				...
				<div class="header-menu">
							...
							<div class="dropdown-menu" aria-labelledby="message">
								...
								<a class="dropdown-item media" href="#"> <span
									class="photo media-left"><img alt="avatar"
										src="${pageContext.request.contextPath}/resources/restaurant/images/avatar/1.jpg"></span>
									...
									class="photo media-left"><img alt="avatar"
										src="${pageContext.request.contextPath}/resources/restaurant/images/avatar/2.jpg"></span>
									<div class="message media-body">
									...
									class="photo media-left"><img alt="avatar"
										src="${pageContext.request.contextPath}/resources/restaurant/images/avatar/3.jpg"></span>
									<div class="message media-body">
									...
									class="photo media-left"><img alt="avatar"
										src="${pageContext.request.contextPath}/resources/restaurant/images/avatar/4.jpg"></span>
									<div class="message media-body">
					...
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle active" data-toggle="dropdown"
							...
							src="${pageContext.request.contextPath}/resources/restaurant/images/admin.jpg"
							alt="User Avatar">
						</a>

						<div class="user-menu dropdown-menu">

							0 <a class="nav-link" href="#"><i class="fa fa- user"></i>My
								Profile</a> <a class="nav-link" href="#"><i class="fa fa- user"></i>Notifications
								<span class="count">13</span></a> <a class="nav-link" href="#"><i
								class="fa fa -cog"></i>Settings</a> <a class="nav-link" href="${pageContext.request.contextPath }/user/logout"><i
	...
	<script
		src="${pageContext.request.contextPath}/resources/restaurant/assets/js/main.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/resources/restaurant/assets/js/init/weather-init.js"></script>

	<script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
	<script
		src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/restaurant/assets/js/init/fullcalendar-init.js"></script>
